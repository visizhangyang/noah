export default function JsonRpcUtilFactory(JsonRpcMd5Factory, JsonRpcHttpFactory) {
  var jsonRpcMd5 = new JsonRpcMd5Factory();
  var jsonRpcHttp = new JsonRpcHttpFactory();
  ...
  return () => {
    var Utils = {
      ...
      ajax: function (opt) {
        ...
        var dfd = new jsonRpcHttp.promise();
        ...
        var sign = jsonRpcMd5.md5(['king-ifa', request, _ic_token_, t].join('@'));
      ...
      getCaptchaUrl: function (width, height) {
        var w = width ? width : '',
          ...
          sign = jsonRpcMd5.md5(['king-ifa', '', sid, t].join('@'));
      ...
      restfulGet: function(url) {
        return this.restful('GET', url);
      },

      restfulPost: function(url, body) {
        return this.restful('POST', url, body);
      },

      restful: function(method, url, body) {
        var params = {
...
JsonRpcUtilFactory.$inject = ['JsonRpcMd5Factory', 'JsonRpcHttpFactory'];
